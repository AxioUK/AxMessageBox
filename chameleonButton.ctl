...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    With PropBag
        MyButtonType = .ReadProperty("ButtonType", 2)
        elTex = .ReadProperty("Caption", "")
        ...
        Set picNormal = .ReadProperty("Picture", Nothing)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    With PropBag
        Call .WriteProperty("ButtonType", MyButtonType)
        Call .WriteProperty("Caption", elTex)
        Call .WriteProperty("Enabled", isEnabled)
        ...
        Call .WriteProperty("Picture", picNormal)
